        ...
        <div className='row'>
            ...
            <div className = "col-md-6 col-sm-12">
                <form className = "formLogin m-5">
                    ...
                    <label for="password" className="form-label">Confirme a password</label>
                    <input type = "password" id = "senha" className = "senha mb-4" placeholder = "confirme a password"></input>
